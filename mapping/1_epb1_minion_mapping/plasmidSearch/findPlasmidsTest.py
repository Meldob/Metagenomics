...
class TestStringMethods(unittest.TestCase):
    ...
    def testNostoc(self):        
        nostocOutput = '/tmp/a'+'.bam'
        subprocess.check_call(./findPlasmidsInBamFile.py+' -i nostoc_azollae_plasmid.fixed.bam/final.contigs.fa.nostoc_azollae_plasmid.fixed.1.fq.bam -o '+nostocOutput, shell=True)
        ...
        self.assertEqual(expectedNostocOutput, nostocOutput)
