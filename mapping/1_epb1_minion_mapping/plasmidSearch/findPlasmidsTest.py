...
path_to_script = '../findPlasmidsInBamFile/./findPlasmidsInBamFile.py'

class TestStringMethods(unittest.TestCase):
    
    
    def testBrassica(self):
        brassicaCommand = path_to_script + ' -i ../test/final.contigs.fa.brassica_napus_plasmid.fixed.1.fq.bam -o /dev/stdout'
    ...
    def testNostoc(self):        
        ...
        nostocCommand = path_to_script + ' -i ../test/final.contigs.fa.nostoc_azollae_plasmid.fixed.1.fq.bam -o /dev/stdout'
    ...
    def testAcetobacter(self):
        acetoCommand = path_to_script + ' -i ../test/final.contigs.fa.AcetobacterPasteurianus.1.fq.bam -o /dev/stdout'
