...
class TestStringMethods(unittest.TestCase):
    ...
    def testBrassica(self):
        brassicaCommand = path_to_script + ' -i brassica_napus_plasmid.fixed.bam/final.contigs.fa.brassica_napus_plasmid.fixed.1.fq.bam -o /dev/stdout'
        brassicaContents = (extern.run(brassicaCommand)).strip()
        
        expectedBrassicaOutput = "blerg"
        expectedBrassicaOutput = expectedNostocOutput.strip()

        print(expectedBrassicaOutput)
        print(brassicaContents)      
