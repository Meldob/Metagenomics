...
class TestStringMethods(unittest.TestCase):
    ...
    def testNostoc(self):        
        ...
        subprocess.check_call(./findPlasmidsInBamFile.py+' -i AcetobacterPasteurianus.bam/final.contigs.fa.AcetobacterPasteurianus.1.fq.bam -o '+bamOutputFile, shell=True)
