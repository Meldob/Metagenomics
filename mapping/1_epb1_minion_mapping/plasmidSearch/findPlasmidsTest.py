...
class TestStringMethods(unittest.TestCase):
    ...
    def testAcetobacter(self):
        acetoCommand = path_to_script + ' -i AcetobacterPasteurianus.bam/final.contigs.fa.AcetobacterPasteurianus.1.fq.bam -o /dev/stdout'
        ...
        expectedAcetoOutput = expectedBrassicaOutput.strip()

        print ""
        print("expected aceto output: " + str(expectedAcetoOutput))
        print ""
        print("actual aceto output: " + str(acetoContents))
        print ""
