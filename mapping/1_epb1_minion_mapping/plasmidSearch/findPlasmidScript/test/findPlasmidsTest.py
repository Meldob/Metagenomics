...
#PLEASE NOTE: you must be in the correct environment and module load extern and pysam before using this test
#module load guix
#eval `guix package -p ~/my-pysam-guix-profile --search-paths=prefix`
#module load extern
